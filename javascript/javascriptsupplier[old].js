...
function alertdelete(kode){
		jConfirm('Are you sure you want to delete Supplier '+kode+'', 'Confirmation Dialog', 	
			...
			if(r==true)
			{
				window.location.href="http://localhost/wahana/index.php/listsupplier/deletesup/"+kode;
			}else{
				window.location.href="http://localhost/wahana/index.php/listsupplier/index/";
			}
		});
	
}

function getsupplier(idx,filter,val,offset,flag,kode){
	//alert(idx+"-"+filter+"-"+val+"-"+offset+"-"+flag+"-"+kode);
	window.location.href="http://localhost/wahana/index.php/listsupplier/index/"+idx+"/"+filter+"/"+val+"/"+offset+"/"+flag+"/"+kode;
}
...
$(document).ready(function(){
	...
	$("#butsearch").click(function(){
		...
		window.location.href="http://localhost/wahana/index.php/listsupplier/index/1/"+filter+"/"+valsearch+"/0";
	...
	$("#btnnewsup").click(function(){	
		window.location.href="http://localhost/wahana/index.php/listsupplier/index/0/asd/0/0/2/";
	});
