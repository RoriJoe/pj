...
function disableinput(){
	...
	$("#txtsatuan").attr("disabled","disabled").css("background-color","#CCC");
	$("#txtket").attr("disabled","disabled").css("background-color","#CCC");
	$("#txtharga").attr("disabled","disabled").css("background-color","#CCC");
	$("#txtstock").attr("disabled","disabled").css("background-color","#CCC");
}
...
function alertdelete(kode){
		jConfirm('Are you sure you want to delete Supplier '+kode+'', 'Confirmation Dialog', 	
			...
			if(r==true)
			{
				window.location.href="http://localhost/wahana/index.php/listbahan/deletebahan/"+kode;
			}else{
				window.location.href="http://localhost/wahana/index.php/listbahan/index/";
			}
		});
	
}

function getbahan(idx,filter,val,offset,flag,kode){
	//alert(idx+"-"+filter+"-"+val+"-"+offset+"-"+flag+"-"+kode);
	window.location.href="http://localhost/wahana/index.php/listbahan/index/"+idx+"/"+filter+"/"+val+"/"+offset+"/"+flag+"/"+kode;
}
...
$(document).ready(function(){
	...
	$("#butsearch").click(function(){
		...
		window.location.href="http://localhost/wahana/index.php/listbahan/index/1/"+filter+"/"+valsearch+"/0";
		
	});
	$("#btncancel").click(function(){
		window.location.href="http://localhost/wahana/index.php/listbahan/index/";
	});
	$("#btnnewbahan").click(function(){	
		window.location.href="http://localhost/wahana/index.php/listbahan/index/0/asd/0/0/2/";
	});
