...
$(document).ready(function(){
	...
	$("#butsearch").click(function(){
		...
		window.location.href="http://localhost/wahana/index.php/salesorderindoor/index/1/"+filter+"/"+valsearch+"/0";
	...
	$("#btncreateindoor").click(function(){	
		window.location.href="http://localhost/wahana/index.php/salesorderindoor/index/0/asd/0/0/2/";
