...
function disableinput(){
	...
	$("#txtnofax").attr("disabled","disabled").css("background-color","#CCC");
	$("#txtcontact").attr("disabled","disabled").css("background-color","#CCC");
	$("#txttelkan").attr("disabled","disabled").css("background-color","#CCC");
	$("#txttelcon").attr("disabled","disabled").css("background-color","#CCC");
	$("#txtaddkan").attr("disabled","disabled").css("background-color","#CCC");
	$("#txtaddcon").attr("disabled","disabled").css("background-color","#CCC");
...
function alertdelete(kode){
		jConfirm('Are you sure you want to delete Supplier '+kode+'', 'Confirmation Dialog', 	
			...
			if(r==true)
			{
				window.location.href="http://localhost/wahana/index.php/listoutsource/deleteoutsource/"+kode;
			}else{
				window.location.href="http://localhost/wahana/index.php/listoutsource/index/";
			}
		});
	
}

function getoutsource(idx,filter,val,offset,flag,kode){
	//alert(idx+"-"+filter+"-"+val+"-"+offset+"-"+flag+"-"+kode);
	window.location.href="http://localhost/wahana/index.php/listoutsource/index/"+idx+"/"+filter+"/"+val+"/"+offset+"/"+flag+"/"+kode;
}
...
$(document).ready(function(){
	...
	$("#butsearch").click(function(){
		...
		window.location.href="http://localhost/wahana/index.php/listoutsource/index/1/"+filter+"/"+valsearch+"/0";
		
	});
	$("#btncancel").click(function(){
		window.location.href="http://localhost/wahana/index.php/listoutsource/index/";
	});
	$("#btnnewoutsource").click(function(){	
		window.location.href="http://localhost/wahana/index.php/listoutsource/index/0/asd/0/0/2/";
	});
