...
function enableinput(){
	$("#txtkodenota").attr("readonly","readonly").css("background-color","#FFC");
	$("#txtkodesj").attr("readonly","readonly").css("background-color","#FFC");
	$("#txttglnota").attr("readonly","readonly").css("background-color","#FFC");
	$("#txtkodepo").attr("readonly","readonly").css("background-color","#FFC");
	$("#txtnamasup").attr("readonly","readonly").css("background-color","#FFC");
	
	$(".namabarang").attr("readonly","readonly").css("background-color","#FCF");
	$(".qtypcs").attr("readonly","readonly").css("background-color","#FCF");
	$(".satuan").attr("readonly","readonly").css("background-color","#FCF");
	$(".harga").attr("readonly","readonly").css("background-color","#FCF");
	$(".jumlah").attr("readonly","readonly").css("background-color","#FCF");
