...
class Account_password extends CI_Controller {
	...
	function index()
	{
		...
		$this->form_validation->set_rules(array(array('field' => 'password_new_password', 'label' => 'Password', 'rules' => 'trim|required|min_length[6]'), array('field' => 'password_retype_new_password', 'label' => 'Re-type Password', 'rules' => 'trim|required|matches[password_new_password]')));
