<?php
	...
	echo '<b>Tanggal: </b><input type="text" id="Tgl" value="" style="border: 0px solid #000000;background-color:rgb(240,240,240);height:18px;" readonly />';
	echo '<table id="tableemploy" border="1" cellpadding="0" cellspacing="0" style=min-width:770px;>
			<thead>
				<tr>
			...
			echo '<tr class=Bold><td colspan=5 align=center >Total</td><td class=FieldDK>'.Uang($TtDb).'</td><td class=FieldDK>'.Uang($TtKr).'</td></tr>
				...
				<b>Tanggal: </b> <input type="text" value="'.GantiDate($Hdata->tanggal).'" style="border: 0px solid #000000;background-color:rgb(240,240,240)" readonly />
				<table id="tableemploy" border="1" cellpadding="0" cellspacing="0" style=min-width:770px;>
					<thead>
						<tr>
							<th>No</th><th>No Voucher</th><th>No Perkiraan</th><th>Nama Perkiraan</th><th style=min-width:200px;>Keterangan</th><th width=70px;>Debit</th><th width=70px;>Kredit</th>
						</tr>
				...
				if($NV!=$Hdata->novoucher){
					if($j!=1)echo '<tr class=Bold><td colspan=5 align=center >Total</td><td class=FieldDK>'.Uang($TtDb).'</td><td class=FieldDK>'.Uang($TtKr).'</td></tr>';
	...
	echo '<table style=min-width:766px; border=0><tr class=Bold><td align=right width=470>Balance :</td><td class=FieldDK width=70px;>'.Uang($GTtDb).'</td><td class=FieldDK width=70px;>'.Uang($GTtKr).'</td></tr></table>';
?>