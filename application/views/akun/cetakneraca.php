...
<head>
	...
	<script>
		...
		$('#Cari').live('click', function(){
			$.ajax({
				type: "POST",	   
				url: "<?php echo base_url(); ?>akun/cetakneraca/searchjurnal",
				data: {bln:$('#bln').val(),thn:$('#thn').val()},
				cache: false,
				success: function(msg){
						$("#ViewJurnal > tbody").html(msg);
						$("div#loading").css("display","none");
		...
		$("#Print").live('click', function(){
			...
			mywindow.document.write('<center>Laporan Neraca<hr size="3" width=150px/>');
	...
	<div class="container" style="margin-bottom:20px;">
    	<div class="row">
    		<div class="span4">
    			...
    			<table border=0>
					<tr>
						<td>Cetak Sampai Akhir Bulan</td>
						<td>: 
							<select id="bln">
								<script>
									for(var i=1; i <= 12 ; i++){
    		...
    		<div class="span8">
    			<h4>View Neraca</h4>
    			<div id="ViewNeraca" class="well" style="height:480px; overflow-y:auto;">
