...
$("#print").click(function(){
	...
	mywindow.document.write('<title>Laporan Outstanding Purchase Order '+tgl+'</title>');
	//mywindow.document.write('<style>.draggable , .tableLap{border-width: 0 0 1px 1px;border-spacing: 0;border-collapse: collapse;border-style: solid;}.draggable td, .tableLap td, .draggable th, .tableLap th{margin: 0;padding: 2px;border-width: 1px 1px 0 0;border-style: solid;background: #C5C5C5; }</style>');
	...
	mywindow.document.write('<table><tr><td width="70%"><h2 style="margin: 0">PD. PELITA JAYA</h2></td><td width="20%">Tanggal : '+tgl+'</td></tr><tr><td width="70%"><b>LAPORAN OUTSTANDING PURCHASE ORDER</b></td><td width="20%" >Halaman : 1</td></tr></table>');
