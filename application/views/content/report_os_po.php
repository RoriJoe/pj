...
$("#print").click(function(){
	...
	mywindow.document.write('<table><tr><td width="70%"><h2 style="margin: 0">PD. PELITA JAYA</h2></td><td width="20%">Tanggal : '+tgl+'</td></tr><tr><td ><h3>LAPORAN OUTSTANDING PURCHASE ORDER</h3></td></tr></table>');
