<?php if ($this->authorization->is_permitted('access_dashboard')) : ?>
    ...
    <div id="content" class="row-fluid">
        <div class="span7">
            <div class="bar-dash filter-bar" style="margin-bottom:5px;border-radius: 3px;">
                ...
                <a href="<?php echo base_url(); ?>dashboard/advance" id="tes2" class="btn btn-default pull-right"  rel="tooltip" data-placement="left" data-original-title="View Full Page Dashboard"><i class="icon-fullscreen"></i> </a>
            </div>
