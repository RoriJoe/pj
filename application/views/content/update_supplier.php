...
<div id="quote">Update Supplier</div> <br/>
...
<table>
       ...
       <td>Limit Kredit</td>
            <td>
                <input type='text' class="validate[required]" value="<?php echo $row->Limit;?>" id='lk2' name='lk' style="width: 215px;">      
            </td>
       </tr>
...
<script>
    ...
    $("#saveup").click(function(){
        ...
        if(pr2 !="" && nm2 !="" && nm2 != "" && al2 != "" && kt2 !="" && tl12 !="" && fx12 != "" && lk2 !="")    
        {
            $.ajax({
            type:'POST',
            url: "<?php echo base_url();?>index.php/ms_supplier/update",
            data :{kd2:kd2,pr2:pr2,nm2:nm2,al2:al2,kt2:kt2,tl12:tl12,tl22:tl22,tl32:tl32,fx12:fx12,fx22:fx22,lk2:lk2},
            success: 
            function(msg){                
                if(msg=="ok")
                {
